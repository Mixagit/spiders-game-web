...
class Player extends Entity {
    ...
    onTouchEntity(obj) {
        if (obj.name === "medkit") {
            ...
            this.soundManager.play("assets/sounds/pick_up_medkit.mp3", {volume: 0.2});
            obj.kill();
        }
        if (obj.name === "ammo") {
            this.ammuniton += 50;
            if (this.ammuniton > 100) this.ammuniton = 100;
            this.soundManager.play("assets/sounds/pick_up_ammo.mp3", {volume: 0.2});
            obj.kill();
        }
        if (obj.name === "portal") {
        ...
        if (obj.name === "spider") {
            this.soundManager.play("assets/sounds/spider_bite.mp3", {volume: 0.2});
        }
    }
...
class Spider extends Entity {
    ...
    update() {
        if (this.lifetime <= 0) {
            this.kill();
            this.soundManager.play("assets/sounds/spider_dead.mp3", {volume: 0.2});
            return;
        }
