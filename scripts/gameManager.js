class GameManager {
    ...
    async update(ctx) {
        ...
        if (!this.entities.find(e => e.name === 'portal')) { // условие перехода на следующий уровень
    ...
    async init() {
        ...
        await this.soundManager.loadArray(["assets/sounds/soundtrack_level_1.mp3", "assets/sounds/soundtrack_level_2.mp3", "assets/sounds/level_up.mp3", "assets/sounds/teleport.mp3", "assets/sounds/pick_up_ammo.mp3", "assets/sounds/pick_up_medkit.mp3", "assets/sounds/spider_bite.mp3", "assets/sounds/spider_dead.mp3", "assets/sounds/shot.mp3", "assets/sounds/game_over.mp3"]);
    }
